		...
		<div class="tp-banner-slider">
			<ul>
				<li data-masterspeed="700">
					<img src="{{asset('rs-plugin/assets/loader.gif')}}" alt>
   				...
   				<li data-masterspeed="700">
					<img src="{{asset('rs-plugin/assets/loader.gif')}}" data-lazyload="http://placehold.it/2000x1000" alt>
   				...
   				<li data-masterspeed="700" data-transition="fade">
					<img src="{{asset('rs-plugin/assets/loader.gif')}}" data-bgposition="center right"  data-lazyload="http://placehold.it/2000x1000" alt>
